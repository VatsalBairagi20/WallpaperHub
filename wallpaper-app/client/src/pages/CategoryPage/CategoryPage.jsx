  ...
  return (
    <div className="category-page-container">
      ...
      <div className="category-layout">
        <main className="category-main-content">
          ...
          <section id="contact" className="category-contact-section">
            ...
            <p className="category-contact-text">Got questions? Reach out to us!</p>
      ...
      <footer className="category-footer">
        <p className="category-footer-text">© 2025 WallpaperHub. All rights reserved.</p>
        <div className="category-social-links">
          <a className="category-social-link" href="https://instagram.com" target="_blank">Instagram</a>
          <a className="category-social-link" href="https://twitter.com" target="_blank">Twitter</a>
        </div>
      </footer>
    </div>
  );
